...
@section('content')
                        ...
                        <table class="table da-table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('product.edit', $product->uuid) }}" class="btn btn-primary btn-sm">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm delete" data-delete="{{ $product->uuid }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    @if(empty(Auth::user()->associate_id))
    <form id="form_export" method="post" action="{{ route('product.export') }}">
        @csrf
        @method('post')
            ...
            $('.delete').on('click', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $('#form_delete').find('#product_delete').val(button.data('delete'));
                        $('#form_delete').submit();
                    }
                })
            });
