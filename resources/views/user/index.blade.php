...
@section('content')
    <div class="da-page container py-5">
        <div class="row">
            <div class="col-12 d-flex align-items-center justify-content-between">
                <h3 class="da-page__title">Usuários</h3>
                <a href="{{ route('user.create') }}" class="btn btn-primary font-weight-bold"
                    title="Cadastrar Usuário">Cadastrar Usuário</a>
            </div>
        </div>
        <div class="row">
                        ...
                        <table class="table da-table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('user.edit', $user->uuid) }}" class="btn btn-primary btn-sm">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm delete" data-delete="{{ $user->uuid }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <form id="form_delete" method="post" action="{{ route('user.delete') }}">
        @csrf
        @method('delete')
        <input type="hidden" name="user" id="user_delete" value="">
    </form>
@endsection
            ...
            $('.delete').on('click', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $('#form_delete').find('#user_delete').val(button.data('delete'));
                        $('#form_delete').submit();
                    }
                })
            });
