...
@section('content')
    <div class="container py-5">
        <div class="row">
            <div class="col-12">
                <div class="bg-white my-3 shadow-sm rounded p-3 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="text-primary" width="40" height="40">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
                        </svg>
                        <p class="m-0 font-weight-bold ml-3">Quer participar do prêmio JCC? Clique no botão 'Inscrever-se'
                            ao lado.</p>
                    </div>
                    <a href="{{ route('enrollment.create') }}" class="btn btn-success m-0 font-weight-bold">Inscrever-se</a>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        @else
                            <div class="d-flex-align-items-center justify-content-center w-100 text-center py-5"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"
                                    ...
                                    <path fill="none" stroke="#4A486A" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-miterlimit="10" stroke-width="10" d="
