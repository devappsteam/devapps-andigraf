...
@section('content')
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-12 col-md">
                <div class="da-box">
                    ...
                    <div class="da-box__description">
                        <div class="da-box__count">{{ $totals['products'] ?? 0 }}</div>
                        <div class="da-box__title">Produtos</div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md">
                <div class="da-box">
                    ...
                    <div class="da-box__description">
                        <div class="da-box__count">{{ $totals['enrollments'] ?? 0 }}</div>
                        <div class="da-box__title">Inscrições</div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md">
                <div class="da-box">
                    ...
                    <div class="da-box__description">
                        <div class="da-box__count">R$ {{ number_format($totals['price'] ?? 0, 2, ',', '.') }}</div>
                        <div class="da-box__title">Valor Total</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-12 col-md-8">
                <div class="da-box da-box--column">
                    <div class="da-box__header mb-1">
                        <h3 class="da-box__title">Últimas inscrições efetuadas</h3>
                        <a href="{{ route('enrollment.index') }}"
                            class="btn btn-primary btn-sm font-weight-bold">Visualizar</a>
                    </div>
                    <div class="da-box_body table-responsive">
                        @if (isset($enrollments) && count($enrollments) > 0)
                            <table class="table da-table table-striped p-0 m-0">
                                <thead>
                                    <tr>
                                        <th>Inscrição</th>
                                        <th>Candidato</th>
                                ...
                                <tbody>
                                    @foreach ($enrollments as $enrollment)
                                        <tr>
                                            <td>{{ str_pad($enrollment->id, 8, 0, STR_PAD_LEFT) }}</td>
                            ...
                            @else
                                <div class="d-flex-align-items-center justify-content-center w-100 text-center py-5"
                                    style="height: 557px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200"
                                        ...
                                        <rect width="419.011" height="113.483" x="31.77" y="381.517" fill="none"
                                            ...
                                            stroke-miterlimit="10" stroke-width="10"></rect>
                            ...
                            c0-4.47-1.483-8.604-3.975-11.927h143.113C310.339,429.654,308.854,433.788,308.854,438.258z">
                                        ...
                                        <polyline fill="none" stroke="#4A486A" stroke-linecap="round"
                                        ...
                                        <polygon fill="none" stroke="#4A486A" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"
                        ...
                        c4.496,0,5.049,4.42,5.257,6.083c0.093,0.742,0.248,2.097,0.248,2.843C400.527,153.388,397.977,155.306,395.51,155.306z">
                                        ...
                                        <g>
                                            <path fill="none" stroke="#4A486A" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"
                                                d="
                        ...
                        l-1.78-12.45c0,0,0-22.5,22.5-22.5S414.489,49.5,414.489,49.5z">
                                            ...
                                            <line x1="400.989" x2="405.489" y1="28.482" y2="18"
                                                fill="none" stroke="#4A486A" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></line>
                                            <line x1="382.989" x2="378.489" y1="28.482" y2="18"
                                                fill="none" stroke="#4A486A" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></line>
                                            <line x1="406.499" x2="377.85" y1="105.43" y2="105.43"
                                                fill="none" stroke="#4A486A" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></line>
                                            <line x1="408.978" x2="375.416" y1="88.07" y2="88.07"
                                                fill="none" stroke="#4A486A" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-miterlimit="10" stroke-width="10"></line>
                                        </g>
                                    </svg>
                ...
                <div class="col-12 col-md-4">
                    <div class="da-widget-clock">
                        <div class="da-widget-clock__date">
                            <div class="spinner-grow" role="status">
                                <span class="sr-only">Carregando...</span>
                            </div>
                        </div>
                        <div class="da-widget-clock__hours">
                            <div class="spinner-grow" role="status">
                                <span class="sr-only">Carregando...</span>
                            </div>
                        </div>
                    </div>
                    <div class="da-box da-box--column mt-5" style="height: 418.8px;">
                        <div class="da-box__header justify-content-center">
                            <h3 class="da-box__title mb-5">Origem dos Associados</h3>
                        </div>
                        <div class="da-box_body">
            ...
            <div class="row mt-4">
                <div class="col-12 col-md-9">
                    <div class="da-box da-box--column">
                        <div class="da-box__header">
                            <h3 class="da-box__title">Total de visualizações do site neste mês</h3>
                        </div>
                        <div class="da-box_body">
                ...
                <div class="col-12 col-md-3">
                    <div class="da-box da-box--column">
                        <div class="da-box__header">
                            <h3 class="da-box__title">Detalhes de Acessos</h3>
                        </div>
                        <div class="da-box_body">
                            <div class="text-center my-4">
                                <p class="font-weight-bold m-0">Acessos Totais</p>
                                <h1 style="font-weight: 900;">497</h1>
                            </div>
                            <div class="text-center my-4">
                                <p class="font-weight-bold m-0">Acessos pelo Celular</p>
                                <h1 style="font-weight: 900;">231</h1>
                            </div>
                            <div class="text-center">
                                <p class="font-weight-bold m-0">Acessos pelo Tablet</p>
                                <h1 style="font-weight: 900;">3</h1>
                            </div>
                            <div class="text-center">
                                <p class="font-weight-bold m-0">Acessos pelo Computador</p>
                                <h1 style="font-weight: 900;">263</h1>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @push('scripts')
        ...
        <script>
            @php
                // Obter o número do dia atual
                $diaAtual = date('j');

                // Criar um array com os dias do mês corrente
                $diasDoMes = range(1, 31);

                // Excluir os dias que são maiores do que o dia atual
                $diasDoMes = array_slice($diasDoMes, 0, $diaAtual);
            @endphp
            const data = {
                labels: JSON.parse('{{ json_encode($diasDoMes) }}'),
                datasets: [{
                    label: false,
                    data: [65,59,80,81,56,55,65,59,80,81,56,55,65,59,19,18,4,8,40],
                    fill: false,
            ...
            const title = "Acessos no mês de " + month;
            ...
            const data_device = {
                labels: ['Site', 'Premiação', 'Manual'],
                datasets: [{
                    data: [{{ $totals['total_site'] ?? 0 }}, {{ $totals['total_award'] ?? 0 }}, {{ $totals['total_manual'] ?? 0 }}],
                }]
            };
