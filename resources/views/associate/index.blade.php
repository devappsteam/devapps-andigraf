...
@section('content')
    <div class="da-page container py-5">
        <div class="row">
            <div class="col-12 d-flex align-items-center justify-content-between">
                <h3 class="da-page__title">Associados</h3>
                <div class="d-flex">
                    <button class="btn btn-primary" id="btn_filter">Filtrar</button>
                    <a href="{{ route('associate.create') }}" class="btn btn-primary font-weight-bold ml-1" title="Cadastrar Associado">Cadastrar Associado</a>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row" style="display:none;" id="form_filter">
            <div class="col-12 mt-3">
                <form method="get">
                    <div class="row">
                        <div class="col-12 col-md-4 form-group">
                            <label for="search">Pesquisar</label>
                            <input type="text" name="search" id="search" class="form-control" placeholder="CNPJ, E-mail, Nome...">
                        </div>
                        <div class="col-12 col-md-4 form-group">
                        ...
                        <div class="col-12 col-md-4 form-group">
                            ...
                            <select name="origin" id="origin" class="form-control">
                                <option value="">Selecione...</option>
                                <option value="award">Inscrição</option>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('associate.index') }}" class="btn btn-secondary">Redefinir</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="row">
            <div class="col-12 mt-4">
                <div class="da-box table-responsive da-box--column">
                        ...
                        <table class="table da-table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Status</th>
                                    <th>Origem</th>
                                    <th width="150" class="text-right">Opções</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <p class="text-truncate m-0">{{ $associate->first_name }}</p>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        @switch ($associate->origin)
                                            ...
                                            @break
                                            @case('site')
                                                <span class="badge badge-warning">Site</span>
                                            @break
                                            @case('award')
                                                <span class="badge badge-success">Inscrição</span>
                                            @break
                                        @endswitch
                                    </td>
                                    <td class="text-right">
                                        <a href="{{ route('associate.user.index', $associate->uuid) }}" class="btn btn-secondary btn-sm" title="Usuário">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                                <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
                                            </svg>
                                        </a>
                                        <a href="{{ route('associate.edit', $associate->uuid) }}" class="btn btn-primary btn-sm">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm delete" data-delete="{{ $associate->uuid }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <form id="form_delete" method="post" action="{{ route('associate.delete') }}">
        @csrf
        @method('delete')
        <input type="hidden" name="associate" id="associate_delete" value="">
    </form>
@endsection
