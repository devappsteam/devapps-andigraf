    ...
    <div class="row">
        <div class="col-12 col-md-6 form-group">
            ...
            <select name="payment_type" class="form-control" id="payment_type" required>
                <option value="">Selecione...</option>
                <option value="credit_card" {{ isset($enrollment) && $enrollment->payment_type == "credit_card" ? "selected" : ""}}>Cartão de Crédito</option>
                <option value="pix" {{ isset($enrollment) && $enrollment->payment_type == "pix" ? "selected" : ""}}>PIX</option>
            </select>
        </div>
        <div class="col-12 col-md-6 form-group">
