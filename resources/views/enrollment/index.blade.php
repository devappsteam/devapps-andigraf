...
@section('content')
                ...
                <form method="get">
                    <div class="row">
                        <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="text" name="search" id="search" class="form-control" placeholder="Número da Inscrição">
                        </div>
                        <div class="col-12 col-md-4 form-group">
                        ...
                        <div class="col-12 col-md-4 form-group">
                            <label for="award">Prêmio</label>
                            <select name="award" class="form-control" id="award">
                                <option value="">Selecione...</option>
                                @if (isset($awards))
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('enrollment.index') }}" class="btn btn-secondary">Redefinir</a>
                        </div>
                    </div>
                </form>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="{{ route('enrollment.view', $enrollment->uuid) }}" class="btn btn-primary btn-sm">
                                        ...
                                        @endif
                                        <button type="button" class="btn btn-danger btn-sm delete" data-delete="{{ $enrollment->uuid }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <form id="form_delete" method="post" action="{{ route('enrollment.delete') }}">
        @csrf
        @method('delete')
        <input type="hidden" name="enrollment" id="enrollment_delete" value="">
    </form>
@endsection
            ...
            $('.delete').on('click', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $('#form_delete').find('#enrollment_delete').val(button.data('delete'));
                        $('#form_delete').submit();
                    }
                })
            });
